...
export const ReturnScalarFieldEnumSchema = z.enum(['id','reason','status','userId','transporterId','orderId','productId','quantity','createdAt','updatedAt','deleted','deletedAt']);
