...
export const ReturnScalarFieldEnumSchema = z.enum(['id','quantity','reason','status','userId','transporterId','orderId','productId','returnAddressId','deliveryNeeded','createdAt','updatedAt','deleted','deletedAt']);
